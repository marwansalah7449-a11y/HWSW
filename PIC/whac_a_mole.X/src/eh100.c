...
#pragma config BORV = 190       // B-up Timer Enable bit (Power up timer disabled)
#pragma config BOREN = SBORDIS  // Brownrown Out Reset Voltage bits (VBOR set to 1.90 V nominal)
